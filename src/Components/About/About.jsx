...
const About = () => {
    return (
        <section className="max-w-screen-xl text-white mx-auto min-h-screen flex gap-6 items-center justify-center flex-col py-8 pb-12">
            ...
            <div>
                <h1 className="downMove font-bold text-transparent lg:text-6xl text-4xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">About <span className="text-white">Me</span></h1>
            </div>
            ...
            <h1 className='md:text-3xl text-2xl font-bold text-white text-center max-w-sm md:max-w-xl'>Hey, I'm thrilled you've dropped in</h1>
