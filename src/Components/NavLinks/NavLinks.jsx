...
const NavLinks = () => {
    ...
    return (
        <>
            ...
            <li style={{animationDelay: getAnimationDelay(3)}} className="topMove"><a onClick={() => handleActiveLink('journey')} className={`hover:text-[#FF6AC2] ${activeLink === 'journey' ? 'text-[#FF6AC2] underline underline-offset-4' : ''}`} href="#journey">Learning Journey</a></li>
